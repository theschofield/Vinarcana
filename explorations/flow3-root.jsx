// FLOW v3 — root App. Same ritual as v2, but the three sequences are driven by
// editable timelines (tlDraw / tlChoice / tlReturn) on a parallel motion clock,
// every card-actor move takes a spring ease, and the Tweaks panel is split into
// Design / Motion tabs with collapsible per-stage folds.

const FLOW3_DEFAULTS = /*EDITMODE-BEGIN*/{
...
function App() {
  const [t, setTweak] = useTweaks(FLOW3_DEFAULTS);
