...
file every new session must read FIRST. Format per entry:
`rN: "line" → grade/outcome` (voice entries untagged for legacy; other layers tagged
`- lens rN:` / `- echo rN:` / `- blurb rN:`).

---

## PREHISTORY — the design-chat rounds (before the Claude Code sessions)

The voice was born in the design explorations (chat rounds 8–12). These trails produced the course
corrections the prompt is built on; they are the earliest calibration data.

### Wheel of Fortune (X)
- d8: "Round it goes. Tonight it stopped on you — don't waste the landing." → REJECTED: condescending inevitability; no excitement, no changing-luck feeling
- d10: "The wheel always turns. Right now? It's turning your way." → REJECTED: forced conversational aside; also "reader learns nothing" (turns of what?)
- d12: "A change in fortune. The kind that arrives without warning." → REJECTED: "bleh" — no fortune-telling feel, no insight, no smile
- d12b: "Luck just walked in — and it's in a generous mood." → liked, superseded by the circling version
- FINAL: "Luck has been circling for a while. Tonight, it lands." → user: "phenomenal, instantly understood"

### The World (XXI)
- d11: "The end of a long road. It looks nothing like the beginning." → REJECTED: words without feeling; no bask, no celebration ("so ChatGPT")
- d12: "Everything in its right place, at last. A feeling this complete doesn't come often." → superseded
- FINAL: "Every last piece, finally in place. This is what the whole road was for." → approved

### Death (XIII)
- d8: "Something's ending. Don't mourn it — this is the good part." → REJECTED: "don't mourn it" is bossy/preachy; but "the good part" flagged interesting
- d10: "Something's ending. The way I see it, that's reason enough to open something good." → REJECTED: stilted + rambling barfly
- d10b: "Something is ending tonight. The good things always make room that way." → closer, superseded
- USER EDIT FINAL: "All things must come to an end. The interesting part is what comes next." — line 1 lets the reader intuit the card BEFORE the spirit's feeling arrives; that ordering became the prompt's "reveal the card" rule

### The Tower (XVI)
- d8: "Everything you believed just cracked. Finally." → REJECTED: "sounds like ChatGPT wrote it"; but "Finally" praised
- d10: "It finally came down — all of it. And honestly? You look relieved." → REJECTED: forced "honestly?" aside; prescribes the reader's feeling
- d10b: "It all came down at last. Strange how light a person feels in the rubble." → second sentence praised; first "trying too hard to refer to something"
- USER REWRITE FINAL: "A spectacular downfall. Strange how light one feels in the rubble."

### The Fool (0)
- d8: "You don't know where this goes. That's the entire point." → REJECTED: condescending, puts words in the reader's mouth
- d10: "No idea where this leads? Lucky you. That's where the good stories start." → REJECTED: talking down
- d11: "You don't know where this leads. That's where every good story starts." → still tells the reader what they don't know
- d12: "No map, no plan, no safety net. Every good story starts exactly like this." → USER EDIT FINAL: "…The start of every good story."

### The Hermit (IX)
- d9: "A little solitude suits you. The quiet's where everything worth hearing has been waiting." → REJECTED: condescending
- d10: "You've gone looking for the quiet. It always knew more than the crowd." → REJECTED: prescribes ("you've gone looking")
- FINAL: "Silence has a way of saying more than the room ever did." → approved (note: flagged once as the most aphoristic of the set — "reads more like an aphorism than a fortune" — but kept)

### The test batch (design chat, to benchmark the Claude Code session)
- Chariot: "All that stubborn drive? It was headed somewhere after all." / alt "Two forces pulling in opposite directions — and somehow, this still ends in a victory lap." → fed the CC trail; user judged the design-chat instinct "more correct out of the gate," final reached by blending both sessions
- Temperance: "Extremes are easy. The magic was always in the mix." → later diagnosed: names the wonder ("magic")
- Star: "The worst is over. What comes now is quieter, clearer — and it glows." / alt "Even the longest night runs out. This is the sky remembering how to shine." → the alt's first clause became the approved line's bones
- Judgement: "Old chapters don't stay closed forever. One of them just called back." / alt "A second chance doesn't knock twice." → both survive inside the current primary/alt pair

**Meta-lesson from the split-session experiment (user-confirmed):** the prompt transfers rules but
not calibration; this history file is the calibration. Read it BEFORE the prompt. Two independent
drafters + the user splitting the difference is a valid production workflow, not a failure mode.

---

**Round-4 course correction:** quality dipped in r3 batch work. Diagnosis: drafting became
defensive (writing around the ban list) instead of speaking from omniscience. Produced bolted-on
second beats ("There it is.") and slogan-compression ("Nothing outruns a made-up mind"). Fix
codified in prompt: drafting mindset section (one true thing about life + second-beat-must-turn
rule + one sentence is complete); bans demoted to post-draft checklist.

**Round-5 course correction:** the fortune-teller frame elevated to the top of the prompt. Lines
are SPOKEN across a table by a devilishly charming spirit right after the card turns over.
Written-English cadence is the enemy ("Every piece was put exactly where…" vs the user's edit
"Every piece, placed exactly where…" — same words, different world). The char limit is pressure
toward natural speech, not compression. Also codified: don't name the wonder ("magic"/"sublime"
label the feeling instead of evoking it — the Temperance failure); direct address allowed as a
wink ("Bit stuck, are we?").

---

## The Magician (I)
- r1: "Nothing here is chance. Every piece was put exactly where it needed to be." → user: sentiment right, try shorter
- r1 alt: "The stars aligned? No — someone aligned them." → retired (em dash ban)
- r2: "Nothing here is chance. Every piece was placed on purpose." → REJECTED: trim killed the intent; "exactly" and "needed" ARE the Magician
- r2 alt: "The stars aligned? Please. Someone aligned them." → REJECTED: bitter/reactive, not omniscient; rhetorical-question-retort banned
- r3: reverted to r1 primary → approved r4, then refined r5
- r5 (user-edited): "Nothing's here by chance. Every piece, placed exactly where it needed to be." → approved; codified as the spoken-cadence calibration example
- r7 (user-edited FINAL, app-fit tweak): "Nothing here is chance. Every piece, placed exactly where it needed to be." → APPROVED

## The High Priestess (II)
- r1: "The truth isn't hiding. It's waiting for someone quiet enough to hear it." → user: close, but "it's not X, it's Y" two-sentence pivot is a ChatGPT tell; "quiet enough to hear it" praised (horoscope principle: reader claims the quality)
- r1 alt: "Some things refuse to be explained. They'd rather be understood." → "kinda sexy but less understandable"
- r2: "Some things would rather be understood than explained. This is one of them." → REJECTED: r1 was better
- r3: comma-splice fix "The truth isn't hiding, it's waiting for someone quiet enough to hear it." → APPROVED r4

## The Empress (III)
- r1: "The world is feeling generous tonight. It would be rude not to accept." → APPROVED (round 2). Sparked the register-may-relax guidance.

## The Emperor (IV)
- r1: "Chaos is charming — until something needs to stand. Then you call the builder." → REJECTED: wordy + em dash
- r1 alt: "Every empire began with someone who refused to leave things to chance." → promoted r2, APPROVED r3

## The Hierophant (V)
- r1: "The old ways survived for a reason. Mostly because they work." → REJECTED: joke reads stiff, tone for the humor not landing
- r1 alt: "Every rule worth breaking was once somebody's hard-won lesson." → REJECTED: reads iconoclastic, misses the card
- r2: "Somebody figured all this out centuries ago. Lucky for us, they wrote it down." → REJECTED: too conversational/chummy
- r2 alt: "The old ways have outlasted every clever new idea. That is no accident." → APPROVED r3, codified as THE register calibration example

## The Lovers (VI)
- r1: "The heart made its choice long before the head was consulted." → APPROVED ("perfect")

## The Chariot (VII)
- r2: "Full speed, steady hands. The finish line never stood a chance." → REJECTED: unplaceable ChatGPT feel; diagnosis: staccato fragment opener
- r2 alt: "Willpower like this doesn't ask permission. It just arrives." → REJECTED: same feel
- r3: "Nothing outruns a made-up mind." → REJECTED: slogan/fortune-cookie about the concept, not a truth about life. Triggered the round-4 prompt breakthrough.
- r3 alt: "Once a direction is truly chosen, the obstacles start losing their nerve." → REJECTED: long-winded
- r4: "The stubborn get called impossible right up until they get called victorious." → direction liked, wording clunky; user sketched the spoken version
- r5 (from user's sketch): "They always call the stubborn impossible. Until they're called victorious, that is." → good, but 84 chars RENDERED AS 3 LINES in the card — char ceiling revised to ~75 in prompt
- r5 alt (different symbolism: harnessing opposing forces): "Wild horses pull most plans apart. Now and then, someone drives them as a team." → not graded
- r6: "They call the stubborn impossible. Right up until the victory lap." → almost perfect
- r7 (user-edited final): "They call the stubborn impossible. Until the victory lap, that is." → APPROVED

## Strength (VIII)
- r2: "Anything can be tamed with a soft enough touch. *Anything*." → close; sentiment and meaning praised; emphasis mechanic retired deck-wide
- r3: "Anything can be tamed with a soft enough touch. Even that." → APPROVED r4

## Wheel of Fortune (X)
- r0 draft: "Luck has been circling for a while. Tonight, it lands." → APPROVED ("perfect")
- r0 alt: "The wheel is turning again — and this time, in a generous direction." → retired

## Justice (XI)
- r2: "Cause, meet effect. The scales were paying attention the whole time." → REJECTED: fragment-opener trope
- r2 alt: "Everything balances out eventually. Consider this eventually." → closer, but user wanted more stones turned
- r3: "The scales take their time, but they never lose count." → APPROVED r4

## The Hanged Man (XII)
- r2: "Stuck, for now. Funny how different everything looks from here." → rejected r2 for echoing The Tower's "Strange how…"; sentiment (stuck + silver lining together) later confirmed right
- r3: "Everything looks different upside down. Some things only make sense that way." → REJECTED: silver lining only, lost the "stuck"
- r3 alt: "A pause was never the plan. The view from here argues otherwise." → REJECTED: weird, forced, ChatGPT-ish
- r4: "Stuck, for now. But some things can only be seen from this angle." → user redirected to fortune-teller direct address ("Bit stuck, are we?")
...
- r2 tighter alt: "Everything ends. The interesting part is what comes next." → r5 verdict: leaning primary; BOTH retained, final call at prototype build

## Temperance (XIV)
- r2: "Patience, proportion, and a steady hand. The quietest kind of magic." → REJECTED: fragment-triplet trope
- r2 alt: "A little of this, a little of that, and somehow: magic." → not graded, same family
- r3: "Mixed in the right measure, opposites stop fighting and start singing." → REJECTED: describes the mechanism of mixing, not a truth about life
- r3 alt: "The middle path gets called boring by everyone who never mastered it." → "kinda interesting maybe"; still alive as alt
- r4: "Too much is easy, too little is safe. The magic has always lived in between." → REJECTED: "magic" is naming the wonder (the Magician never needed the word). Spawned the don't-name-the-wonder ban.
- User direction: something about balance and discipline being sublime; deeply wine-resonant, deserves better
- r5: "Restraint, of all things, turns out to be where the finest pleasures hide." → APPROVED r6

## The Devil (XV)
- r0: "*Finally*, a little indulgence." → rejected (user's offhand nudge taken literally) — but the SENTIMENT later vindicated
- r0 draft: "Resistance was a noble effort. It was never going to last." → superseded
- r0 alt: "Temptation only wins when it knows exactly what to offer. And it knows." → primary r3–r4; demoted to contender r5
- r2: "Being good was fun while it lasted. Let's be bad together." → REJECTED: cheerleading, not seduction
- r3 alt (user's own wording): "Finally, a little indulgence. Come on, let's be bad." → contender
- r3 comparison: "Everyone has a price. It appears tonight found yours." → PROMOTED TO PRIMARY r5 (user's pick for now)
...
- r4: "Even the longest night runs out of dark eventually. This would be that moment." → user questioned whether sentence two is needed
- r5: "Even the longest night runs out of dark eventually." → very close; user flagged "Even"/"eventually" repetition
- r6: "Even the longest night runs out of dark." → REJECTED: feels incomplete. Lesson: a trailing word can be load-bearing for completeness even when it looks redundant on paper; the ear outranks the eye.
- r7: "Even the longest night runs out of dark eventually." → APPROVED (r5 version restored)

## The Moon (XVIII)
- original gold standard: "Things are not as they seem tonight. Good — they rarely are."
- r5 (user selected em-dash-free variant): "Things are not as they seem tonight. Good. They rarely are." → APPROVED, now canonical

## The Sun (XIX)
- r3: "Everything is exactly as good as it looks. Enjoy it; that's rarer than it sounds." → REJECTED: right message, clunky; second beat template-filling
- r3 alt: "The simplest pleasures never needed defending. Today proves it." → second sentence cut per user; codified one-sentence-is-complete rule
- r4: "The simplest pleasures never needed defending." → superseded by alt preference
- r4 alt: "Every so often, the world simply says yes." → APPROVED r5

## Judgement (XX)
- r3: "The reckoning came and went. What is left standing gets to begin again." → REJECTED: not kickass enough for this card
- r3 alt: "A second chance rarely announces itself. It just quietly opens the door." → not graded
- r4: "Everyone dreads the reckoning. Hardly anyone mentions how often it forgives." → first beat KEPT ("everyone dreads the reckoning"); second sentence odd to say; absolution/forgiveness theme confirmed
- r5: "Everyone dreads the reckoning. Forgiveness was always the likelier verdict." → second sentence felt odd to say; absolution theme kept
- r5 alt: "Everyone dreads the reckoning. And yet, so many walk away forgiven." → not graded
...
- r0 alt: "A journey completed. Go ahead — savor it; it's yours." → retired

---

## Overnight first pass — self-rejections worth keeping (2026-07-07)

### Ten of Cups (C10)
- r1: "Happiness this whole doesn't visit. It moves in." → (self-rejected, first pass) punchy negation pivot; the comma-rescue would clone the High Priestess's bones. Landed on "Most joys pass through. This kind unpacks."

### Eight of Cups (C08)
- r1: "The heart knows when a place is finished, long before the feet agree." → (self-rejected, first pass) same bones as The Lovers' approved "The heart made its choice long before the head was consulted."

### Four of Swords (S04)
- r1: "Even a sharp blade spends most of its life at rest. That is no accident." → (self-rejected, first pass) second beat is the Hierophant's exact close. Landed on "The mind wins more battles asleep than anyone admits."
